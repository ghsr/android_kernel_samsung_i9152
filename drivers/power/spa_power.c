...
/* #define SPA_DBG_LEVEL_INTERNAL SPA_DBG_LEVEL4 */
/* #define SPA_DBG_LEVEL_OUT SPA_DBG_LEVEL4 */
...
static int spa_back_charging_work(struct work_struct *work)
{
	...
	struct power_supply *ps;
	union power_supply_propval value;
	struct spa_power_desc *spa_power_iter = container_of(work, struct spa_power_desc, back_charging_work);
...
static void spa_init_config(struct spa_power_desc *spa_power_iter)
{
	...
	//spa_power_iter->charger_info.charger_name="bcm59054_charger";
